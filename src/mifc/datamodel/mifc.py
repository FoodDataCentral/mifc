...
# Generation date: 2026-02-13T12:22:43
# Schema: mifc
#
...
class Person(NamedThing):
    ...
    class_class_uri: ClassVar[URIRef] = MIFC["Person"]
    class_class_curie: ClassVar[str] = "mifc:Person"
    class_name: ClassVar[str] = "Person"
    class_model_uri: ClassVar[URIRef] = MIFC.Person
...
class PersonCollection(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = MIFC["PersonCollection"]
    class_class_curie: ClassVar[str] = "mifc:PersonCollection"
    class_name: ClassVar[str] = "PersonCollection"
    class_model_uri: ClassVar[URIRef] = MIFC.PersonCollection
...
slots.personCollection__entries = Slot(uri=MIFC.entries, name="personCollection__entries", curie=MIFC.curie('entries'),
                   model_uri=MIFC.personCollection__entries, domain=None, range=Optional[Union[dict[Union[str, PersonId], Union[dict, Person]], list[Union[dict, Person]]]])

slots.Person_primary_email = Slot(uri=SCHEMA.email, name="Person_primary_email", curie=SCHEMA.curie('email'),
                   model_uri=MIFC.Person_primary_email, domain=Person, range=Optional[str],
